...
public class Create_steamy {
    ...
    public static final DeferredBlock<Block> CAM_LINKAGE_BLOCK =
            BLOCKS.registerSimpleBlock("cam_linkage", BlockBehaviour.Properties.of());
    public static final DeferredItem<BlockItem> CAM_LINKAGE =
            ITEMS.registerSimpleBlockItem(CAM_LINKAGE_BLOCK);
